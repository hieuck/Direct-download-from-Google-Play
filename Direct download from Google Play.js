...
function addButtons(){
    ...
    if(price==0){
      ...
      b7.id="aptoidebutton";
      let b7a=document.createElement("A");
      b7a.style.backgroundColor="#fe6446";
      b7a.className=cn;
      b7a.textContent="Aptoide";
      b7.appendChild(b7a);
      ...
      var ddlButton7=document.getElementById("aptoidebutton");
      ddlButton7.onclick=function(){ddl(this,aptoideURL);};
